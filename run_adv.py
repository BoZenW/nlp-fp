...
def main():
    ...
    #argp.add_argument('--remove_unused_columns', action="store_false", help="as described")
    ...
    if args.dataset.endswith('.json') or args.dataset.endswith('.jsonl'):
        ...
        dataset_addOne = datasets.load_dataset('squad_adversarial','AddOneSent')
        dataset_addSent = datasets.load_dataset('squad_adversarial','AddSent')
        dataset_orig = datasets.load_dataset('squad')
    ...
    if training_args.do_train:
        ...
        train_dataset = datasets.concatenate_datasets([dataset_orig["train"], dataset_addOne["validation"]])
    ...
    if training_args.do_eval:
        ...
        # eval_dataset = dataset_addOne['validation']
        eval_dataset = dataset_addSent['validation']
