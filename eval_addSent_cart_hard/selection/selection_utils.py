...
def log_training_dynamics(output_dir: os.path,
    ...
    # print("\n\n************** train_golds:", train_golds[:5])

    # print('train logits shape: ', np.array(train_logits).shape)
    # print('i: ', len(train_logits))
    # print('j: ', len(train_logits[0]))
    # print('train_logit[0]', train_logits[0])
